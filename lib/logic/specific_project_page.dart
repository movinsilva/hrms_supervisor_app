...
class SpecificProjectData{
  ...
  static Future<SubLevelsModel> getProjects(int id) async {
    var data = await http.get("http://" + RuntimeConstants.ip + ":" + RuntimeConstants.port + "/Api/supervisorapi/getallsublevelsforprojectid?projectid=" + id.toString() );
